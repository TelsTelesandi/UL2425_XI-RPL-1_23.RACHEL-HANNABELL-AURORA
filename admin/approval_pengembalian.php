...
<head>
    ...
    <title>Approval Pengembalian - E-Sarpras</title>
...
<body>
    <div class="wrapper">
        ...
        <nav class="sidebar">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="approval_pengembalian.php">
                                ...
                                <tbody>
                                    ...
                                    while ($row = mysqli_fetch_assoc($result)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-sm btn-success" onclick="approveReturn(<?php echo $row['peminjaman_id']; ?>)">
                                                    <i class="bi bi-check-lg"></i> Terima Kembali
                                                </button>
                                            </td>
                                        </tr>
                                    <?php } ?>
    ...
    <script>
        function approveReturn(id) {
            if (confirm('Apakah Anda yakin ingin menerima pengembalian ini?')) {
                window.location.href = 'proses_pengembalian.php?id=' + id + '&action=approve';
            }
        }
    </script>
</body>
